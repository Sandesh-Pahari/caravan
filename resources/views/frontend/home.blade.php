...
@section('pagecontent')
    ...
    <section class="relative min-h-screen bg-[#0b0b0b] overflow-hidden">
        ...
        <div class="absolute inset-0 pointer-events-none overflow-hidden">
            <div class="absolute top-1/4 -left-40 w-[700px] h-[500px] rounded-full blur-[140px]"
                style="background:rgba(79,195,247,0.05)"></div>
            <div class="absolute top-1/3 right-0 w-[500px] h-[400px] rounded-full blur-[120px]"
                style="background:rgba(139,30,45,0.06)"></div>
        </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-52 sm:pb-64 lg:pb-80">
            ...
            {{-- Badge --}}
            <div class="inline-flex items-center gap-2 border border-brand-sky/25 text-brand-sky text-xs font-semibold px-4 py-2 rounded-full mb-8"
            ...
            <p class="text-gray-400 text-base md:text-lg max-w-xl mb-10 leading-relaxed">
                From bustling city streets to remote mountain trails — rent a vehicle with an experienced driver or go
                self-drive. Professional, reliable, always on time.
            </p>
        ...
        <div class="absolute inset-x-0 bottom-0 pointer-events-none select-none">
            ...
            {{-- Car image --}}
            <img src="{{ asset('car/car.png') }}" alt="Caravan Rental Vehicle" class="car-float w-full"
            ...
            @for ($i = 0; $i < 2; $i++)
                <div class="flex items-center flex-shrink-0">
                    @foreach (['Verified Drivers', 'Premium Fleet', '24/7 Support', 'Secure Payments', 'Nepal-wide Service', 'Self Drive Available', 'Airport Transfers', 'Mountain Routes'] as $item)
                        <span
                            class="text-brand-dark text-xs font-black uppercase tracking-widest px-6">{{ $item }}</span>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div class="svc-card rounded-2xl p-7 reveal" style="background:rgba(255,255,255,0.03)">
                    <div class="svc-icon w-12 h-12 rounded-xl flex items-center justify-center mb-5 text-white"
                        style="background:rgba(255,255,255,0.08)">
                        <i class="fas fa-user-tie text-lg"></i>
                    </div>
                    <div class="sg text-6xl font-extrabold leading-none mb-4 select-none"
                        style="color:rgba(255,255,255,0.06)">01</div>
                    <h3 class="text-white font-bold text-xl mb-3">With Driver</h3>
                    <p class="text-gray-500 text-sm leading-relaxed mb-6">
                        Sit back while our experienced, licensed drivers take you safely to your destination — anywhere in
                        Nepal.
                    </p>
                    ...
                    <a href="{{ route('rental.vehicles.index') }}"
                        class="inline-flex items-center gap-2 text-brand-sky text-xs font-semibold group">
                        Book a Driver <i
                ...
                <div class="svc-card rounded-2xl p-7 reveal relative overflow-hidden"
                    style="background:rgba(79,195,247,0.08); border-color:rgba(79,195,247,0.2)!important; transition-delay:0.12s">
                    <div
                        class="absolute top-4 right-4 bg-brand-sky text-brand-dark text-[10px] font-black px-2.5 py-1 rounded-full uppercase tracking-wide">
                        Popular</div>
                    <div class="svc-icon w-12 h-12 rounded-xl flex items-center justify-center mb-5 text-brand-sky"
                        style="background:rgba(79,195,247,0.2)">
                        <i class="fas fa-taxi text-lg"></i>
                    </div>
                    <div class="sg text-6xl font-extrabold leading-none mb-4 select-none"
                        style="color:rgba(79,195,247,0.12)">02</div>
                    <h3 class="text-white font-bold text-xl mb-3">Self Drive</h3>
                    <p class="text-gray-400 text-sm leading-relaxed mb-6">
                        Take the wheel yourself. Enjoy the freedom of driving through Nepal's stunning landscapes at your
                        own pace.
                    </p>
                    <ul class="space-y-2.5 mb-8">
                ...
                {{-- Tours & Transfers --}}
                <div class="svc-card rounded-2xl p-7 reveal"
                    style="background:rgba(255,255,255,0.03); transition-delay:0.24s">
                    <div class="svc-icon w-12 h-12 rounded-xl flex items-center justify-center mb-5 text-white"
                        style="background:rgba(255,255,255,0.08)">
                        <i class="fas fa-mountain-sun text-lg"></i>
                    </div>
                    <div class="sg text-6xl font-extrabold leading-none mb-4 select-none"
                        style="color:rgba(255,255,255,0.06)">03</div>
                    <h3 class="text-white font-bold text-xl mb-3">Tours & Transfers</h3>
                    <p class="text-gray-500 text-sm leading-relaxed mb-6">
                        Airport pickups, hotel transfers, trekking base camp runs, and full-day sightseeing tours arranged
                        on request.
                    </p>
                    <ul class="space-y-2.5 mb-8">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6">
                <div class="flex items-end justify-between mb-14">
                    ...
                    <a href="{{ route('rental.vehicles.index') }}"
                        ...
                        style="transition-delay:0.1s" onmouseenter="this.style.background='rgba(255,255,255,0.06)'"
                        onmouseleave="this.style.background='transparent'">
                        ...
                        <div class="veh-card group rounded-2xl overflow-hidden reveal"
                            ...
                            <div class="relative overflow-hidden">
                                <a href="{{ route('rental.vehicles.show', $vehicle) }}">
                                    <img src="{{ Storage::url($vehicle->main_image) }}"
                                        alt="{{ $vehicle->vehicle_name }}" class="veh-img w-full h-56 object-cover">
                                </a>
                                @php
                                ...
                                @endphp
                                <span
                                    class="absolute top-3 right-3 text-[10px] font-black px-2.5 py-1 rounded-full shadow {{ $conditionBadge }}">
                            ...
                            <div class="p-6">
                                <div class="flex items-center justify-between">
                                    <a href="{{ route('rental.vehicles.show', $vehicle) }}">
                                        <h3
                                            class="text-lg font-semibold text-white group-hover:text-brand-sky transition capitalize">
                                            {{ $vehicle->vehicle_name }}</h3>
                                    </a>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-6">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-semibold text-white">{{ $vehicle->number_of_seats }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3">
    ...
    <section class="bg-[#0f0f0f] py-24 border-t border-white/[0.04]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                @foreach ([['fa-magnifying-glass', 'Browse & Pick', 'Explore our fleet and choose the right vehicle — city car, 4WD jeep, or minibus.'], ['fa-file-pen', 'Fill Details', 'Enter your pickup date, destination, and contact info. Takes less than 2 minutes.'], ['fa-circle-check', 'Confirm & Go', 'We confirm your booking within hours. Show up and you\'re ready to go.']] as $idx => $step)
                    <div class="step-wrap text-center reveal" style="transition-delay:{{ $idx * 0.13 }}s">
                        <div class="relative inline-flex mb-6">
                            <div class="step-icon w-20 h-20 border border-white/10 rounded-2xl flex items-center justify-center"
                                style="background:rgba(255,255,255,0.04)">
                                <i class="fas {{ $step[0] }} text-brand-sky text-2xl"></i>
                            </div>
                            <span
                                class="absolute -top-2 -right-2 bg-brand-sky text-brand-dark sg text-xs font-black w-6 h-6 rounded-full flex items-center justify-center">{{ $idx + 1 }}</span>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="reveal">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed mb-4">
                        Caravan Vehicle Rentals has been serving locals, tourists, and businesses across Nepal for years.
                        Based in Lalitpur, we operate a carefully maintained fleet suited for everything from Kathmandu
                        valley commutes to remote mountain expeditions.
                    </p>
                    <p class="text-gray-500 text-sm leading-relaxed mb-8">
                        Our drivers know Nepal's roads intimately — from the flat Terai to the winding mountain passes —
                        ensuring you arrive safely and on time, every time.
                    </p>
                    <a href="{{ route('contact') }}"
                ...
                <div class="grid grid-cols-2 gap-4 reveal" style="transition-delay:0.15s">
                    <div class="rounded-2xl p-7 text-center border border-white/[0.08]"
                        style="background:rgba(255,255,255,0.04)">
            ...
            <div class="max-w-3xl mx-auto px-4 sm:px-6">
                ...
                <div x-data="{ active: null }" class="space-y-2">
                    @foreach ($faqs as $i => $faq)
                        <div class="faq-item rounded-xl overflow-hidden reveal"
                            ...
                            <button @click="active = active === {{ $i }} ? null : {{ $i }}"
                                ...
                                <div class="w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0 transition"
                                    ...
                                    <i class="fas text-xs"
                                        :class="active === {{ $i }} ? 'fa-minus' : 'fa-plus'"></i>
                                </div>
                            </button>
                            <div x-show="active === {{ $i }}"
                    ...
                    @foreach ($policies as $idx => $policy)
                        ...
                        <div class="rounded-2xl p-6 transition-colors reveal"
                            ...
                            <div class="flex items-center gap-3 mb-5">
                                <div
                                    class="w-10 h-10 rounded-xl {{ $colors['bg'] }} flex items-center justify-center flex-shrink-0">
                                ...
                                @foreach ($policy->items as $item)
                                    <li class="flex items-start gap-2.5 text-xs text-gray-500">
                                        <span class="w-1 h-1 rounded-full mt-1.5 flex-shrink-0"
                                            style="background:rgba(79,195,247,0.5)"></span>
                                        {{ $item }}
                                    </li>
                                @endforeach
                            </ul>
    ...
    <section class="relative bg-[#0b0b0b] py-28 border-t border-white/[0.04] overflow-hidden">
        <div class="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
            <div class="sg font-extrabold text-white leading-none select-none whitespace-nowrap"
                style="font-size:22vw; color:rgba(255,255,255,0.025)">CARAVAN</div>
        </div>
        <div class="absolute inset-0 pointer-events-none">
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] rounded-full blur-[100px]"
                style="background:rgba(79,195,247,0.04)"></div>
        </div>
        ...
        <div class="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            <h2 class="sg text-4xl md:text-6xl font-extrabold text-white mb-6 leading-tight reveal"
                style="transition-delay:0.1s">
                Start Your<br>Journey Today.
            </h2>
            <p class="text-gray-500 text-sm mb-10 max-w-md mx-auto leading-relaxed reveal" style="transition-delay:0.2s">
                Browse our fleet, pick your vehicle, and book online in minutes. Or contact us — we're happy to help plan
                your trip.
            </p>
