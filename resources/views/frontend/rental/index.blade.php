...
@section('pagecontent')
    ...
    <div class="bg-gradient-to-r from-brand-dark to-brand-slate py-10 px-4">
        <div class="max-w-7xl mx-auto">
            <p class="text-xs font-semibold text-brand-sky uppercase tracking-widest mb-1">Rental Fleet</p>
            <h1 class="text-3xl font-bold text-white mb-1">Our Vehicles</h1>
            <p class="text-sm text-white/55">Choose from our carefully maintained fleet of rental vehicles.</p>
        </div>
    </div>
    ...
    <div class="bg-brand-bg min-h-screen">
        <div class="max-w-7xl mx-auto px-4 py-10">
            <div class="flex items-center justify-between mb-8">
                <p class="text-sm text-gray-500">{{ $vehicles->count() }} vehicle{{ $vehicles->count() !== 1 ? 's' : '' }} available</p>
                @auth
