...
<body class="bg-brand-bg">
    ...
    <nav>
       ...
       <a href="" class="flex items-center space-x-2 px-4 py-3 hover:bg-brand-slate rounded">
         ...
         <!-- FAQs -->
        <a href="{{ route('admin.faqs.index') }}" class="flex items-center space-x-2 px-4 py-3 hover:bg-brand-slate rounded">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Policies -->
        <a href="{{ route('admin.policies.index') }}" class="flex items-center space-x-2 px-4 py-3 hover:bg-brand-slate rounded">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
